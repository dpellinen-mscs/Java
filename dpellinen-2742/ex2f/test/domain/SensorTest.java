...
//import static dataaccess.SensorReadingJSONParser.json;
...
class SensorTest {
    ...
    @Test
    void testFindMinReadingIndex1() {
        int startIndex = 0;
        int endIndex = 4;

        int minIndex = this.sensor.findMinReadingIndex1(startIndex, endIndex);

        assertEquals(29, this.sensor.findMinReadingIndex1(startIndex, endIndex));
    }
    @Test
    void testFindMinReadingIndex1StartIndexLow() {
        int startIndex = -1;
        int endIndex = 4;

        assertThrows(IndexOutOfBoundsException.class, () -> {
            this.sensor.findMinReadingIndex1(startIndex, endIndex);
        });
    }

    @Test
    void testFindMinReadingIndex1EndIndexHigh() {
        int startIndex = 0;
        int endIndex = 118;
    ...
    @Test
    void testFindMinReadingStartHigherThanEnd() {
        int startIndex = 5;
        int endIndex = 4;
    ...
    @Test
    void findMaxReadingIndex1StartIndexLow() {
        int startIndex = -1;
        int endIndex = 4;
    ...
    @Test
    void findMaxReadingIndex1EndIndexHigh() {
        int startIndex = 0;
        int endIndex = 118;
    ...
    @Test
    void testFindMaxReadingStartHigherThanEnd() {
        int startIndex = 5;
        int endIndex = 4;
    ...
    void findMaxReadingIndex1() {
        ...
        assertEquals(33, this.sensor.findMaxReadingIndex1(startIndex, endIndex));
    ...
    void findNextCycleMaxIndex() {
        ...
        assertEquals(5, this.sensor.findNextCycleMax(startIndex));
    ...
    void findNextCycleMinIndex() {
        ...
        assertEquals(0, this.sensor.findNextCycleMin(startIndex));
