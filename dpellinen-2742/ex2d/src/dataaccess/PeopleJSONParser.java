...
//                            if (tenant != null) people.add(getTenant(jsonPerson));
                            break;
...
//                            if (contractAdministrator != null) people.add(getContractAdministrator(jsonPerson));
                            break;
...
//                            if (hourlyAdministrator != null) people.add(getHourlyAdministrator(jsonPerson));
                            break;
                    }
                }
