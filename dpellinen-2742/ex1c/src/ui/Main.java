...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("ex1c: Composite Invoice Class");

        GDate date1 = new GDate(2019, 9, 1);
        GDate date2 = new GDate(2019, 9, 11);

        LineItem lineItem1 = new LineItem(1000, "2019 Sept Rent");
        ...
        LineItem lineItem4 = new LineItem(1000, "2019 Sept Rent");
        ...
        Invoice invoice5 = invoice1.copy();
        System.out.println("invoice5 = " + invoice5);
